...
- 🌱 Aprendiendo constantemente: **Django, PostgreSQL, React**
- 🔭 Trabajando en mi **[Portafolio Personal](https://portafolio-cristian-aranda.onrender.com/)**
...
class CristianAranda:
    def __init__(self):
        self.nombre = "Cristian Aranda Borquez"
        self.rol = "Full Stack Developer"
        self.ubicacion = "Quillota, Chile"
        
    def educacion(self):
        return {
            "2017-2021": "Trabajador Social - Universidad Santo Tomás",
            "2024-2025": "Full Stack Python/Django - Talento Digital"
        }
    
    def habilidades_actuales(self):
        return {
            "backend": ["Python", "Django", "PostgreSQL", "MySQL"],
            "frontend": ["HTML", "CSS", "JavaScript", "Bootstrap"],
            "tools": ["Git", "GitHub", "VS Code", "Render"],
            "soft_skills": ["Trabajo en Equipo", "Resolución de Problemas", 
                          "Comunicación", "Adaptabilidad"]
        }
    
    def proximos_pasos(self):
...
⭐ **Si te gusta lo que hago, no dudes en seguirme o contactarme** ⭐
